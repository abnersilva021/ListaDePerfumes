...
public class ListaPerfumes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtPesquisa.setBackground(new java.awt.Color(51, 255, 51));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 660, 330));

        btSalvar.setBackground(new java.awt.Color(0, 0, 0));
        btSalvar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/enter.png"))); // NOI18N
        btSalvar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btSalvarActionPerformed(evt);
            }
        });
        jPanel1.add(btSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 120, 60, 60));

        btEditar.setBackground(new java.awt.Color(0, 0, 0));
        btEditar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/caneta.png"))); // NOI18N
        btEditar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btEditarActionPerformed(evt);
            }
        });
        jPanel1.add(btEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 280, 60, 60));

        btListar.setBackground(new java.awt.Color(0, 0, 0));
        btListar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/lista.png"))); // NOI18N
        btListar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btListarActionPerformed(evt);
            }
        });
        jPanel1.add(btListar, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 360, 60, 60));

        btOrdenar.setBackground(new java.awt.Color(0, 0, 0));
        btOrdenar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/alfabeto.png"))); // NOI18N
        btOrdenar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btOrdenarActionPerformed(evt);
            }
        });
        jPanel1.add(btOrdenar, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 450, 60, 60));

        jLabel4.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel4.setText("Pesquisar:");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 560, 150, 60));

        txtPerfume.setBackground(new java.awt.Color(51, 255, 51));
        ...
        btExcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/lixeira.png"))); // NOI18N
        btExcluir.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btExcluirActionPerformed(evt);
            }
        });
        jPanel1.add(btExcluir, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 200, 60, 60));
        ...
        lbLista.setFont(new java.awt.Font("Arial", 1, 36)); // NOI18N
        lbLista.setText("LISTA PERFUMES");
        jPanel1.add(lbLista, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 40, -1, -1));
